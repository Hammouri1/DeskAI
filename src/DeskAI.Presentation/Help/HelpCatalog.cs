...
public static class HelpCatalog
{
    ...
    [
        ...
        new("search.readInside", "Reading inside files",
            ...
            "Search can read notes and modern Word and Excel files. A further yes lets it search PDF text. Results show a short matching piece.",
            "It never reads photos or scanned pages, and never saves or sends extracted words to AI."),
