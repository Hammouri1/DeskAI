...
/// <summary>
/// A folder under the system temp directory that this test run created and will delete.
/// </summary>
/// <remarks>
/// Page tests connect folders exactly as a person would, so the folder they connect must be
/// one the test made and filled with generated files. It refuses to create or delete
/// anything outside its own owned directory.
/// </remarks>
public sealed class TemporaryDirectory : IDisposable
{
    ...
    public void Dispose()
    {
        ...
        {
            // SQLite pools connections; release them so the database file can be deleted.
